...
public class Village {
	...
	private static class Marche {
		...
		/*
		 * constructeur Marche INPUT: nb etals du marche
		 */
		...
		private Etal[] trouverEtals(String produit) {
			...
			// traverse tous les Etals et ajoute a etalsTouves ce contenant le produit
			// cherhé
			for (Etal etal : etals) {
	...
	public String installerVendeur(Gaulois vendeur, String produit, int nbProduit) {
		...
		if (numEtal != -1) {
			...
			chaineInstallerVendeur.append(
					"Le vendeur " + vendeur.getNom() + " vend des " + produit + " à l'étal n°" + (numEtal + 1) + ".\n");
		} else {
	...
	// methode rechercher etal
	public Etal rechercherEtal(Gaulois vendeur) {
		return marche.trouverVendeur(vendeur);
	}
	
	//methode partir Vendeur
